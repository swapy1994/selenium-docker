#------------------------------------------------------------------------#
# This script expects following environment varaibles
#       HUB_HOST	
#		BROWSER
#		THREAD_COUNT
#		TEST_SUITE
...
#Let's print what we have recieved
echo "-------------------------------------------"
...
#Do not start the tests immediately. Hun has to be ready with browser nodes
